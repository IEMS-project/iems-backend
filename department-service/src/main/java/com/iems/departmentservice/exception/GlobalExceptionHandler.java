...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<String>> handleAppException(AppException ex, WebRequest request) {
        DepartmentErrorCode errorCode = ex.getErrorCode();
    ...
    public ResponseEntity<ApiResponseDto<String>> handleGlobalException(Exception ex, WebRequest request) throws Exception {
        ...
        ApiResponseDto<String> response = new ApiResponseDto<>(
                DepartmentErrorCode.INTERNAL_SERVER_ERROR.getHttpStatus().name(),
                DepartmentErrorCode.INTERNAL_SERVER_ERROR.getMessage(),
                null
        );
        return new ResponseEntity<>(response, DepartmentErrorCode.INTERNAL_SERVER_ERROR.getHttpStatus());
    }
}
