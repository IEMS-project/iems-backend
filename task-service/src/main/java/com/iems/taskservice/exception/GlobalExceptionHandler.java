...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<String>> handleAppException(AppException ex, WebRequest request) {
        TaskErrorCode errorCode = ex.getErrorCode();
    ...
    public ResponseEntity<ApiResponseDto<String>> handleGlobalException(Exception ex, WebRequest request) throws Exception {
        ...
        ApiResponseDto<String> response = new ApiResponseDto<>(
                TaskErrorCode.INTERNAL_SERVER_ERROR.getHttpStatus().name(),
                TaskErrorCode.INTERNAL_SERVER_ERROR.getMessage(),
                null
        );
        return new ResponseEntity<>(response, TaskErrorCode.INTERNAL_SERVER_ERROR.getHttpStatus());
    }
}
