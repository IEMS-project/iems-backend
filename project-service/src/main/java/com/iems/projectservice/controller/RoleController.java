...
public class RoleController {
    ...
    public ResponseEntity<ApiResponseDto<Role>> createRole(
            ...
            @Valid @RequestBody CreateRoleDto dto) throws AppException {
    ...
    public ResponseEntity<ApiResponseDto<Void>> deleteRole(
            @PathVariable UUID projectId,
            @PathVariable UUID roleId) throws AppException {
    ...
    public ResponseEntity<ApiResponseDto<List<Role>>> getRoles(@PathVariable UUID projectId) throws AppException {
    ...
    public ResponseEntity<ApiResponseDto<Void>> assignPermission(
            @PathVariable UUID projectId,
            @PathVariable UUID roleId,
            @PathVariable ProjectPermission permission) throws AppException {
    ...
    public ResponseEntity<ApiResponseDto<List<ProjectPermission>>> getAllPermissions(
            @PathVariable UUID projectId) throws AppException {
